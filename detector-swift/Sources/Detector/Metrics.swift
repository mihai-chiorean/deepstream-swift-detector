...
// End-to-end pipeline latency on a live RTSP source can span a wide range
// (RTP timestamps may predate the pipeline's base_time by seconds). Wide
// bucket set so the histogram captures both realistic per-frame jitter and
// clock-skew-inflated absolute figures.
private let latencyBuckets: [Double] = [10, 25, 50, 100, 250, 500, 1000, 2500, 5000, 10000]
